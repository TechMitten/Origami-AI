...
export const ChatEmptyState: React.FC<ChatEmptyStateProps> = ({
  ...
  <div className="mx-auto flex min-h-full w-full max-w-3xl flex-col justify-center px-1 py-10">
    ...
    <p className="mt-3 max-w-xl text-sm leading-relaxed text-white/45">
      The model runs on your GPU through WebLLM. It downloads once, then answers with no
      network call — prompts, screenshots and clips stay on this device.
    </p>
    ...
    <ul className="mt-6 flex flex-wrap items-center gap-x-5 gap-y-2">
      ...
      <Fact label="Weights" value={modelSize || 'Unknown size'} />
